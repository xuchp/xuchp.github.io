import{_ as s,c as a,o as n,a7 as i}from"./chunks/framework.BvW0rtPM.js";const u=JSON.parse('{"title":"30. Vue 中 .sync 修饰符的作用？","description":"","frontmatter":{},"headers":[],"relativePath":"InterviewVue/30.Vue 中.sync修饰符的作用？.md","filePath":"InterviewVue/30.Vue 中.sync修饰符的作用？.md"}'),e={name:"InterviewVue/30.Vue 中.sync修饰符的作用？.md"},t=i(`<h1 id="_30-vue-中-sync-修饰符的作用" tabindex="-1">30. Vue 中 .sync 修饰符的作用？ <a class="header-anchor" href="#_30-vue-中-sync-修饰符的作用" aria-label="Permalink to &quot;30. Vue 中 .sync 修饰符的作用？&quot;">​</a></h1><p>在有些情况下，我们可能需要对一个 prop 进行&quot;双向绑定&quot;，这时可以使用.sync 来实现。v-model 默认只能双向绑定一个属性，这里就可以通过<code>.sync</code>修饰符绑定多个属性。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">\`&lt;my :value.sync=&quot;xxxx&quot;&gt;&lt;/my&gt;\`</span></span>
