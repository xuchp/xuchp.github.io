...
`,l:"Vue插件/批量导入svg.html#一-安装插件",a:"一-安装插件"},"61.2":{t:"二、在 vite.config.ts 中配置",p:`iconDirs:iconDirs 是保存 svg 图片的文件夹，可以填写多个
&lt;img src=&quot;https://raw.githubusercontent.com/xuchp/ty ...`,l:"Vue插件/批量导入svg.html#二、在-vite-config-ts-中配置",a:"二、在-vite-config-ts-中配置"},"61.3":{t:"三、封装 svg 组件",p:`&lt;template&gt;
  &lt;svg :class=&quot;svgClass&quot; aria-hidden=&quot;true&quot;&gt;
    &lt;use  ...`,l:"Vue插件/批量导入svg.html#三、封装-svg-组件",a:"三、封装-svg-组件"},"61.4":{t:"四、配置全局组件并引入插件",p:`import { type App } from 'vue'
import SvgIcon from '@/components/SvgIcon/index.vue' // svg component ...`,l:"Vue插件/批量导入svg.html#四、配置全局组件并引入插件",a:"四、配置全局组件并引入插件"},"61.5":{t:"五、在 main.ts 中引入",p:`import { useSvgIcon } from '@/icons'
useSvgIcon(app)
...
funct ...`,l:"basic/JavaScript 核心原理精讲.html#常见的实现继承的方法",a:"常见的实现继承的方法"},"62.9":{t:"如何实现 new、apply、call、bind 的底层逻辑",p:`JavaScript 中的 apply、call 和 bind 方法是前端代码开发中相当重要的概念，并且与 this 的指向密切相关
new 原理介绍
new 关键词的主要作用，就是指向一个构造函数， ...`,l:"basic/JavaScript 核心原理精讲.html#如何实现-new、apply、call、bind-的底层逻辑",a:"如何实现-new、apply、call、bind-的底层逻辑"},"62.10":{t:"闭包",p:`JavaScript 的作用域： 指变量能够被访问到的范围
...
new Array
new Array(arg1,arg2...)参数长度为 0 或长度大于等于 2 时，传入的参数将 ...`,l:"basic/JavaScript 核心原理精讲.html#array-的构造器",a:"array-的构造器"},"62.17":{t:"Array 的判断",p:`Array.isArray
用来判断一个变量是否为数组类型
`,l:"basic/JavaScript 核心原理精讲.html#array-的判断",a:"array-的判断"},"62.18":{t:"Array 的方法",p:"改变自身的方法：pop、push、reverse、shift、sort、splice、unshift、以及两个 ES6 新增的方法 copyWithin 和 fill不改变自身的方法：concat、j ...",l:"basic/JavaScript 核心原理精讲.html#array-的方法",a:"array-的方法"},"62.19":{t:"数组扁平化",p:`数组的扁平化其实就是讲一个嵌套多层的数组 array(嵌套可以是任何层数)转化为只有一层的数组
扁平化实现方法
...
非比较类排序： 不通过比较来决定元素之间的相对次序，它可以突破基于比较排序的时 ...`,l:"basic/JavaScript 核心原理精讲.html#排序分类",a:"排序分类"},"62.24":{t:"sort 排序",p:`通过 sort 方法也可以实现数组的排序，默认排序顺序是先将元素转换为字符串，然后再进行排序
语法是arr.sort([compareFunction])
compareFunction

如果 co ...`,l:"basic/JavaScript 核心原理精讲.html#sort-排序",a:"sort-排序"},"63.0":{t:"# CSS",p:"",l:"basic/css.html",a:"css"},"63.1":{t:"介绍一下 CSS 的盒子模型",p:`CSS 的盒子模型有哪些:标准盒子模型、IE 盒子模型
CSS 盒子模型的区别
...
`,l:"harmonyOS/入门.html",a:"image-png"},"73.1":{t:"1.1. 准备开发环境",p:"",l:"harmonyOS/入门.html#_1-1-准备开发环境",a:"_1-1-准备开发环境"},"73.2":{t:"1.1.1. 安装 IDE",p:"鸿蒙应用开发需要使用配套的 IDE——HUAWEI DevEco Studio。 DevEco Studio基于 IntelliJ IDEA Community（IDEA 社区版）构建，为鸿蒙应用提供 ...",l:"harmonyOS/入门.html#_1-1-1-安装-ide",a:"_1-1-1-安装-ide"},"73.3":{t:"1.1.2. 配置 IDE",p:`安装完成后，可按以下步骤完成初始化配置
...
初次启动会出现如下设置向导，首先需要为no ...`,l:"harmonyOS/入门.html#_1-1-2-配置-ide",a:"_1-1-2-配置-ide"},"73.4":{t:"1.2. 创建项目",p:`下面我们创建第一个鸿蒙应用项目
...
`,l:"harmonyOS/入门.html#_1-3-运行项目",a:"_1-3-运行项目"},"73.6":{t:"1.3.1. Preview 预览",p:"Previewer预览用于查看应用的 UI 界面效果，方便随时调整界面 UI 布局。只需打开需要预览的页面文件，例如下图中的Index.ets，然后点击 IDE 右侧的Perviewer即可看到预览效 ...",l:"harmonyOS/入门.html#_1-3-1-preview-预览",a:"_1-3-1-preview-预览"},"73.7":{t:"1.3.2. 模拟器运行",p:`Previewer预览器主要用于查看界面 UI 效果，如需对项目进行更加深入的测试，可以使用模拟器运行项目。初次使用需要先安装模拟器，安装步骤如下

点击Tools菜单下的Device Manager ...`,l:"harmonyOS/入门.html#_1-3-2-模拟器运行",a:"_1-3-2-模拟器运行"},"73.8":{t:"1.3.3. 真机运行",p:`使用模拟器运行应用时，会占用电脑较多的资源，并且有些功能无法进行测试。当模拟器不满足要求时，可选择真机运行。真机运行的步骤如下

准备一台装有Harmony OS系统的手机，系统版本最好为4.0.0及 ...`,l:"harmonyOS/入门.html#_1-3-3-真机运行",a:"_1-3-3-真机运行"},"73.9":{t:"2.1. 概述",p:"HarmonyOS 应用的主要开发语言是 ArkTS，它由 TypeScript（简称 TS）扩展而来，在继承 TypeScript 语法的基础上进行了一系列优化，使开发者能够以更简洁、更自然的方式开 ...",l:"harmonyOS/入门.html#_2-1-概述",a:"_2-1-概述"},"73.10":{t:"2.2. TypeScript 快速入门",p:"",l:"harmonyOS/入门.html#_2-2-typescript-快速入门",a:"_2-2-typescript-快速入门"},"73.11":{t:"2.2.1. 运行环境说明",p:"",l:"harmonyOS/入门.html#_2-2-1-运行环境说明",a:"_2-2-1-运行环境说明"},"73.12":{t:"2.2.1.1. 线上 Playground",p:`TypeScript 提供了一个线上的 Playground 供练习使用，地址为https://www.typescriptlang.org/zh/play。
!img
`,l:"harmonyOS/入门.html#_2-2-1-1-线上-playground",a:"_2-2-1-1-线上-playground"},"73.13":{t:"2.2.1.2. 本地运行环境",p:`除去线上的运行环境，我们也可以在本地搭建一个 TS 的运行环境。
...
let a ...`,l:"harmonyOS/入门.html#_2-2-3-4-数组",a:"_2-2-3-4-数组"},"73.23":{t:"2.2.3.5. 对象",p:"在 TS 中，对象（object）是一种一系列由属性名称和属性值组成的数据结构，例如姓名:'张三', 年龄:10, 性别:'男'。对象类型的声明需要包含所有属性的名称及类型，例如{name: stri ...",l:"harmonyOS/入门.html#_2-2-3-5-对象",a:"_2-2-3-5-对象"},"73.24":{t:"2.2.4. 函数",p:"",l:"harmonyOS/入门.html#_2-2-4-函数",a:"_2-2-4-函数"},"73.25":{t:"2.2.4.1. 函数声明语法",p:`声明函数的基础语法如下
!img
...
function sum(a: number, b: ...`,l:"harmonyOS/入门.html#_2-2-4-3-2-类型推断",a:"_2-2-4-3-2-类型推断"},"73.32":{t:"2.2.4.4. 函数声明特殊语法",p:`
匿名函数
...
面向对象编程（Object-Oriented Programming，简称 OOP）是一种编程范式，其核心理念在于将程序中的数据与操作数据的方法有 ...`,l:"harmonyOS/入门.html#_2-2-5-1-概述",a:"_2-2-5-1-概述"},"73.35":{t:"2.2.5.2. 语法说明",p:"",l:"harmonyOS/入门.html#_2-2-5-2-语法说明",a:"_2-2-5-2-语法说明"},"73.36":{t:"2.2.5.2.1. 类的定义",p:`定义类的语法如下图所示
!img
代码如下：
...
定义静态成员需要使用s ...`,l:"harmonyOS/入门.html#_2-2-5-2-3-静态成员",a:"_2-2-5-2-3-静态成员"},"73.39":{t:"2.2.5.3. 继承",p:"继承是面向对象编程中的重要机制，允许一个类（子类或派生类）继承另一个类（父类或基类）的属性和方法。子类可以直接使用父类的特性，并根据需要添加新的特性或覆盖现有的特性。这种机制赋予面向对象程序良好的扩展 ...",l:"harmonyOS/入门.html#_2-2-5-3-继承",a:"_2-2-5-3-继承"},"73.40":{t:"2.2.5.4. 访问修饰符",p:`访问修饰符（Access Modifiers）用于控制类成员（属性、方法等）的可访问性。TypeScript 提供了三种访问修饰符，分别是private、protected和public。
...
let person: { name: string; age: n ...`,l:"harmonyOS/入门.html#_2-2-6-5-ts-中的接口的特殊性",a:"_2-2-6-5-ts-中的接口的特殊性"},"73.47":{t:"2.2.7. 枚举",p:"",l:"harmonyOS/入门.html#_2-2-7-枚举",a:"_2-2-7-枚举"},"73.48":{t:"2.2.7.1. 概述",p:`枚举（Enumeration）是编程语言中常见的一种数据类型，其主要功能是定义一组有限的选项，例如，方向（上、下、左、右）或季节（春、夏、秋、冬）等概念都可以使用枚举类型定义。
...
枚举的使用记住 ...`,l:"harmonyOS/入门.html#_2-2-7-2-语法说明",a:"_2-2-7-2-语法说明"},"73.50":{t:"2.2.7.3. 赋值",p:`在 TypeScript 中，枚举实际上是一个对象，而每个枚举值都是该对象的一个属性，并且每个属性都有具体的值，属性值只支持两种类型——数字或字符串。
默认情况下，每个属性的值都是数字，并且从 0 开 ...`,l:"harmonyOS/入门.html#_2-2-7-3-赋值",a:"_2-2-7-3-赋值"},"73.51":{t:"2.2.8. 模块化",p:"",l:"harmonyOS/入门.html#_2-2-8-模块化",a:"_2-2-8-模块化"},"73.52":{t:"2.2.8.1. 概述",p:"模块化是指将复杂的程序拆解为多个独立的文件单元，每个文件被称为一个模块。在 TypeScript 中，默认情况下，每个模块都拥有自己的作用域，这意味着在一个模块中声明的任何内容（如变量、函数、类等）在 ...",l:"harmonyOS/入门.html#_2-2-8-1-概述",a:"_2-2-8-1-概述"},"73.53":{t:"2.2.8.2. 语法说明",p:`
导出
...
export default func ...`,l:"harmonyOS/入门.html#_2-2-8-4-默认导入导出",a:"_2-2-8-4-默认导入导出"},"73.56":{t:"2.3. ArkTS 快速入门",p:`ArkTS 在继承了Typescript语法的基础上，主要扩展了声明式 UI 开发相关的能力。
`,l:"harmonyOS/入门.html#_2-3-arkts-快速入门",a:"_2-3-arkts-快速入门"},"73.57":{t:"2.3.1. 声明式 UI",p:`声明式 UI是一种编写用户界面的范式。下面通过一个具体案例来学习这种开发范式，假如现在要实现如下界面
!img
`,l:"harmonyOS/入门.html#_2-3-1-声明式-ui",a:"_2-3-1-声明式-ui"},"73.58":{t:"2.3.1.1. 定义界面状态",p:`按照声明式 UI 的开发范式，首先需要分析和定义页面的各种状态，并声明相应的状态变量用于表示不同的状态。
当前案例中，界面共有两个状态，分别是开灯和关灯状态，所以我们可以使用一个boolean类型的变 ...`,l:"harmonyOS/入门.html#_2-3-1-1-定义界面状态",a:"_2-3-1-1-定义界面状态"},"73.59":{t:"2.3.1.2. 描述界面显示效果",p:`在分析完界面状态后，我们需要准确的描述界面在不同状态下的显示效果。
在当前案例中，具体逻辑如下图所示
!img
...
为了实现点 ...`,l:"harmonyOS/入门.html#_2-3-1-3-改变状态",a:"_2-3-1-3-改变状态"},"73.61":{t:"2.3.1.4. 总结",p:`以上就是声明式 UI 开发范式的大致流程，下面为大家总结一下声明式 UI 的核心思想
...
状态 ...`,l:"harmonyOS/入门.html#_2-3-1-4-总结",a:"_2-3-1-4-总结"},"73.62":{t:"2.3.2. 组件化",p:"在鸿蒙开发中，组件是构成界面的最小单元，我们所看到的界面，都是由众多组件组合而成的，所以编写界面其实就是组合组件的过程，ArkTS 提供了很多的内置组件，例如：Text、Button、Image等等； ...",l:"harmonyOS/入门.html#_2-3-2-组件化",a:"_2-3-2-组件化"},"73.63":{t:"2.3.3. 入门案例",p:"",l:"harmonyOS/入门.html#_2-3-3-入门案例",a:"_2-3-3-入门案例"},"73.64":{t:"2.3.3.1. 案例效果",p:`案例的最终效果如下图所示
!img
...
!img
案例的完整代码见：Demos/entry/src/main/ets/pa ...`,l:"harmonyOS/入门.html#_2-3-4-2-2-案例实操",a:"_2-3-4-2-2-案例实操"},"73.71":{t:"2.3.4.3. 渲染控制",p:"",l:"harmonyOS/入门.html#_2-3-4-3-渲染控制",a:"_2-3-4-3-渲染控制"},"73.72":{t:"2.3.4.3.1. 条件渲染",p:"",l:"harmonyOS/入门.html#_2-3-4-3-1-条件渲染",a:"_2-3-4-3-1-条件渲染"},"73.73":{t:"2.3.4.3.1.1. 概述",p:`条件渲染可根据应用的不同状态渲染不同的 UI 界面，例如前文的开/关灯案例，以及以下的播放/暂停案例，均可使用条件渲染实现。
!img
案例的完整代码见：Demos/entry/src/main/et ...`,l:"harmonyOS/入门.html#_2-3-4-3-1-1-概述",a:"_2-3-4-3-1-1-概述"},"73.74":{t:"2.3.4.3.1.2. 语法说明",p:`条件渲染的语法如下
if (...){
  //UI描述
}else if (...){
  //UI描述
...
ForEach(
  ...
  k ...`,l:"harmonyOS/入门.html#_2-3-4-3-2-2-语法说明",a:"_2-3-4-3-2-2-语法说明"},"73.78":{t:"3.1. 图片",p:"",l:"harmonyOS/入门.html#_3-1-图片",a:"_3-1-图片"},"73.79":{t:"3.1.1. 概述",p:`Image为图片组件，用于在应用中显示图片。
...
Resource类型的 ...`,l:"harmonyOS/入门.html#_3-2-2-参数",a:"_3-2-2-参数"},"73.88":{t:"3.2.3. 常用属性",p:"",l:"harmonyOS/入门.html#_3-2-3-常用属性",a:"_3-2-3-常用属性"},"73.89":{t:"3.2.3.1. 字体大小",p:`字体大小可通过fontSize()方法进行设置，该方法的参数类型为string | number| Resource，下面逐一介绍

string 类型

string类型的参数可用于指定字体大小的具 ...`,l:"harmonyOS/入门.html#_3-2-3-1-字体大小",a:"_3-2-3-1-字体大小"},"73.90":{t:"3.2.3.2. 字体粗细",p:`字体粗细可通过fontWeight()方法进行设置，该方法参数类型为number | FontWeight | string，下面逐一介绍
...
Color\`为枚举类型，其中 ...`,l:"harmonyOS/入门.html#_3-2-3-3-字体颜色",a:"_3-2-3-3-字体颜色"},"73.92":{t:"3.2.3.4. 文本对齐",p:`文本对齐方向可通过textAlign()方法进行设置，该方法的参数为枚举类型TextAlign，可选的枚举值如下
...
相关 ...`,l:"harmonyOS/入门.html#_3-3-3-2-边框圆角",a:"_3-3-3-2-边框圆角"},"73.100":{t:"3.3.4. 常用事件",p:`对于 Button 组件而言，最为常用的就是点击事件，可以通过onClick()方法为按钮绑定点击事件，该方法的参数为一个回调函数，当按钮被点击时，就会触发该回调函数，例如
...
!img
`,l:"harmonyOS/入门.html#_3-4-3-1-选中状态背景色",a:"_3-4-3-1-选中状态背景色"},"73.106":{t:"3.4.3.2. Swtich 滑块颜色",p:`可使用设置switchPointColor()方法设置Switch类型的 Toggle 组件中的圆形滑块颜色，例如
!img
相关案例见：Demos/entry/src/main/ets/pages/ ...`,l:"harmonyOS/入门.html#_3-4-3-2-swtich-滑块颜色",a:"_3-4-3-2-swtich-滑块颜色"},"73.107":{t:"3.4.4. 常用事件",p:"Toggle组件常用的事件为change事件，每当Toggle组件的状态发生变化，就会触发change事件。开发者可通过onChange()方法为Toggle组件绑定change事件，该方法参数为一个 ...",l:"harmonyOS/入门.html#_3-4-4-常用事件",a:"_3-4-4-常用事件"},"73.108":{t:"3.5. 文本输入",p:"",l:"harmonyOS/入门.html#_3-5-文本输入",a:"_3-5-文本输入"},"73.109":{t:"3.5.1. 概述",p:`TextInput为文本输入组件，用于接收用户输入的文本内容。
...
!img
`,l:"harmonyOS/入门.html#_3-5-3-2-光标样式",a:"_3-5-3-2-光标样式"},"73.114":{t:"3.5.3.3. placeholder 样式",p:"可通过placeholderFont()和placeholderColor()方法设置 placeholder 的样式，其中placeholderFont()用于设置字体，包括字体大小、字体粗细等，p ...",l:"harmonyOS/入门.html#_3-5-3-3-placeholder-样式",a:"_3-5-3-3-placeholder-样式"},"73.115":{t:"3.5.3.4. 文本样式",p:`输入文本的样式可通过fontSize()、fontWeight()、fontColor()等通用属性方法进行设置。
相关案例见：Demos/entry/src/main/ets/pages/compo ...`,l:"harmonyOS/入门.html#_3-5-3-4-文本样式",a:"_3-5-3-4-文本样式"},"73.116":{t:"3.5.4. 常用事件",p:"",l:"harmonyOS/入门.html#_3-5-4-常用事件",a:"_3-5-4-常用事件"},"73.117":{t:"3.5.4.1. change 事件",p:`每当输入的内容发生变化，就会触发 change 事件，开发者可使用onChange()方法为TextInput组件绑定 change 事件，该方法的参数定义如下
onChange(callback:  ...`,l:"harmonyOS/入门.html#_3-5-4-1-change-事件",a:"_3-5-4-1-change-事件"},"73.118":{t:"3.5.4.2. 焦点事件",p:"焦点事件包括获得焦点和失去焦点两个事件，当输入框获得焦点时，会触发 focus 事件，失去焦点时，会触发 blur 事件，开发者可使用onFocus()和onBlur()方法为 TextInput 组 ...",l:"harmonyOS/入门.html#_3-5-4-2-焦点事件",a:"_3-5-4-2-焦点事件"},"73.119":{t:"3.6. 进度条",p:"",l:"harmonyOS/入门.html#_3-6-进度条",a:"_3-6-进度条"},"73.120":{t:"3.6.1. 概述",p:`Progress为进度条组件，用于显示各种进度。
...
style({
  ...
  scaleC ...`,l:"harmonyOS/入门.html#_3-6-3-1-进度条样式",a:"_3-6-3-1-进度条样式"},"73.124":{t:"3.6.3.2. 进度条颜色",p:`进度条的颜色可通过color()和backgroundColor()方法进行设置，其中color()用于设置前景色，backgroundColor()用于设置背景色，例如
!img
相关案例见：Dem ...`,l:"harmonyOS/入门.html#_3-6-3-2-进度条颜色",a:"_3-6-3-2-进度条颜色"},"73.125":{t:"3.7. 弹窗",p:`弹窗是移动应用中常见的一种用户界面元素，常用于显示一些重要的信息、提示用户进行操作或收集用户输入。ArkTS 提供了多种内置的弹窗供开发者使用，除此之外还支持自定义弹窗，来满足各种不同的需求。
...
\`\`\`json&lt;br/&gt;{&lt;br/&gt; &quot;integer ...`,l:"harmonyOS/入门.html#_3-7-5-2-使用说明",a:"_3-7-5-2-使用说明"},"75.0":{t:"# 如何理解node中模块的概念",p:`模块化规划
`,l:"node/1.如何理解node中模块的概念.html",a:"如何理解node中模块的概念"},"75.1":{t:"软件工程的本质是什么？",p:`
管路数据
管理变量
...
管理变量 ...`,l:"node/1.如何理解node中模块的概念.html#软件工程的本质是什么",a:"软件工程的本质是什么"},"75.2":{t:"模块化的方案",p:"",l:"node/1.如何理解node中模块的概念.html#模块化的方案",a:"模块化的方案"},"76.0":{t:"动态 CSS",p:"",l:"vue-challenge/CSS Features.html",a:"动态-css"},"76.1":{t:"题目",p:`Vue单文件组件 \`
